...
class RedisMessageSubscriberTest {
    ...
    void onMessage() throws SettingUnavailableException, JsonProcessingException, InterruptedException {
        ...
        final Response<String> builder1 = Response.success(objectMapper.writeValueAsString(testSetting));

        given(configService.load(any(String.class))).willAnswer(invocation -> builder1);
        // when
