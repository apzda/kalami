...
import com.apzda.hajimi.configure.listener.RedisMessageSubscriber;
...
class RedisConfiguration {
    ...
    @Bean("configChangedMessageTopic")
    @Qualifier("configChangedMessageTopic")
    ChannelTopic configChangedMessageTopic() {
        log.debug("The Configure Topic is: configChangedMessageQueue");
