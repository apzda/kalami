...
import com.apzda.hajimi.captcha.SliderCaptcha;
 ...
 **/
@Slf4j
public abstract class SliderUtil {
    ...
    public static SliderCaptcha createSliderCaptcha(@Nonnull SerializableStream sliderFile,
            @Nonnull SerializableStream noiseFile, @Nonnull SerializableStream originalFile, String watermark,
            int noise) throws Exception {
