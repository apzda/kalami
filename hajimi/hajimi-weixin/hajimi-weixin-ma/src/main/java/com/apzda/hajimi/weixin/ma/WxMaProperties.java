 ...
 */
@Data
@ConfigurationProperties(prefix = "hajimi.weixin.ma")
public class WxMaProperties {
     ...
     * 通知回调地址
     */
    private String callback = "wxMa";

    /**
     * 消息格式，XML或者JSON
     */
    private MsgDataFormat msgDataFormat = MsgDataFormat.JSON;
     ...
     * 小程序配置
     */
    private final List<WxMaConfiguration> configs = new ArrayList<>();
