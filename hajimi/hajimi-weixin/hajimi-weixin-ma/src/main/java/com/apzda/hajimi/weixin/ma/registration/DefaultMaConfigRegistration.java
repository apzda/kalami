 ...
 */
package com.apzda.hajimi.weixin.ma.registration;
...
public class DefaultMaConfigRegistration implements WxMaConfigRegistration {

    private final WxMaProperties properties;

    @Override
    public WxMaConfiguration loadConfig(String appId) {
        if (CollectionUtils.isEmpty(properties.getConfigs())) {
            return null;
        }

        WxMaConfiguration config;
        if (StringUtils.isBlank(appId) || "default".equalsIgnoreCase(appId)) {
