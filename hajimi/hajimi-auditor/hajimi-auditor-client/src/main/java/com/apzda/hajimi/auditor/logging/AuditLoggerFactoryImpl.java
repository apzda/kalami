...
public class AuditLoggerFactoryImpl implements AuditLoggerFactory {
    ...
    @Override
    public Logger create(String activity) {
        if (StringUtils.isBlank(activity)) {
            throw new IllegalArgumentException("activity is blank");
        }
        return new Logger(activity, auditService, objectMapper, observationRegistry);
    }
