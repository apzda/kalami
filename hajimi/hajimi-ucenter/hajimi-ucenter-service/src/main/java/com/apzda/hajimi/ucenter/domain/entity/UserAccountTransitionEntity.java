 ...
 */
@Data
@TableName(value = "ucenter_user_account_transition", autoResultMap = true)
public class UserAccountTransitionEntity implements Serializable {

    @Serial
    private static final long serialVersionUID = -5597315343903980649L;
