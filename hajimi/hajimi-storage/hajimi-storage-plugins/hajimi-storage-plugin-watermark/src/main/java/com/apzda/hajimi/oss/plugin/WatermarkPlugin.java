 ...
 */
@Slf4j
public class WatermarkPlugin extends AbstractPlugin<Map<String, String>> {
    ...
    public UploadedFile alter(UploadedFile file, String path, OssBackend ossBackend) throws Exception {
        ...
        val props = mapConfig;
        val watermark = props.getString(PROP_WATERMARK_S);
        ...
        graphics.dispose();
        val tmpImg = FileUtil
            .createTempFile("water_", "." + file.getExt(), new File(props.getString(PROP_TMPDIR_S)).toPath())
            .toAbsolutePath()
            .toString();
