 ...
 */
package com.apzda.hajimi.sms.service.sender;
...
@Slf4j
public class ThreadPoolSender implements SmsSender<Map<String, Object>>, ThreadFactory {
    ...
    @Override
    public void init(Map<String, Object> config, Map<String, SmsProvider> enabledSmsProviders) throws Exception {
