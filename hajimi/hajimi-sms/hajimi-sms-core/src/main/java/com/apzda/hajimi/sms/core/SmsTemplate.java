 ...
 */
package com.apzda.hajimi.sms.core;
...
import com.apzda.hajimi.sms.core.data.SmsInfo;
...
public class SmsTemplate {
    ...
    public void beforeSend(Sms sms, TempStorageService storage) throws Exception {
    ...
    public void onSent(Sms sms, TempStorageService storage) throws Exception {
        val phone = sms.getPhone();
    ...
    public boolean verify(Sms sms, TempStorageService storage) {
        if (sms.isTestMode()) {
            return true;
        }
        val phone = sms.getPhone();
