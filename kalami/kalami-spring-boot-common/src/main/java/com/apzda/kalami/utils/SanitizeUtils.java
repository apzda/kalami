...
public abstract class SanitizeUtils {
    ...
    public static <T> T sanitize(Field field, @Nonnull Method method, @Nullable T value) {
        if (value == null) {
            return null;
        }

        Sanitized annotation = method.getAnnotation(Sanitized.class);
        if (annotation == null && field != null) {
            annotation = field.getAnnotation(Sanitized.class);
        }
