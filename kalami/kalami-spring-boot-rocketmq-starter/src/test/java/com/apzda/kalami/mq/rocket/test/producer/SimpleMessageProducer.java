 ...
 * along with this program.  If not, see <https://www.gnu.org/licenses/>.
 */
package com.apzda.kalami.mq.rocket.test.producer;

import com.apzda.kalami.mq.rocket.config.RocketMqConfigProperties;
import com.apzda.kalami.mq.rocket.producer.RocketmqProducer;
...
public class SimpleMessageProducer extends RocketmqProducer<SimpleMessage, Tags> {
    ...
    public SimpleMessageProducer(@Nonnull RocketMqConfigProperties.ProducerConfig config) {
        super(config);
    }
