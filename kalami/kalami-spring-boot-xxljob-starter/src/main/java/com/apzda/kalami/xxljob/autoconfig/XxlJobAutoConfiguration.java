...
package com.apzda.kalami.xxljob.autoconfig;
...
public class XxlJobAutoConfiguration {
    ...
    public XxlJobSpringExecutor xxlJobExecutor(XxlJobConfigProperties properties, Environment environment) {
        val admin = properties.getAdmin();
        val executor = properties.getExecutor();
        val defaultAppName = environment.getProperty("spring.application.name", "xxl-job");
